...
- Crie um projeto react com create-vite: `npm init --yes vite@latest geradordeimagensia -- --template=react-ts  --no-rolldown --no-immediate`.
- Atualizando `vite.config.ts`com a porta.
- Criar o arquivo de projeto (`geradordeimagensia.esproj`).
